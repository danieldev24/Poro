...
import com.apps.daniel.poro.presentation.labels.AddEditLabelsAdapter.OnEditLabelListener
...
import com.apps.daniel.poro.helpers.SimpleItemTouchHelperCallback
...
import com.apps.daniel.poro.databinding.ActivityAddEditLabelsBinding
import com.apps.daniel.poro.presentation.statistics.Utils.getInvalidLabel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addLabelView.onFocusChangeListener =
            OnFocusChangeListener { _: View?, hasFocus: Boolean ->
                ...
                imageLeft.setImageResource(if (hasFocus) R.drawable.ic_palette else R.drawable.ic_add)
